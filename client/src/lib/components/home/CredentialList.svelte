<script lang="ts">
	...
	let tableHeading = ['Nome', 'Usuário', 'Senha'];
	let tableData = [
		{
			name: 'Github',
			username: 'jv-vogler',
...
<div class="flex flex-col items-center gap-8">
	...
	<div
		class="relative flex h-full w-full flex-col overflow-scroll rounded-lg bg-white bg-clip-border text-gray-700 shadow-md"
	>
